...
func DefaultCommands() []Command {
	commands := []Command{
		command("prompt.insert", "Insert prompt", "Prompt", "Start composing in the active agent buffer.", "i", "prompt", "composer", "insert"),
		command("prompt.send", "Send prompt", "Prompt", "Send the composer text to the active buffer.", "Enter", "send", "chat", "prompt"),
		...
		command("terminal.share", "Live-share terminal with agent", "Shell", "Enable direct terminal_read and terminal_write tools for the selected terminal.", ":st/:share-term/:share-terminal [n]", "terminal", "share", "context", "control"),
		...
		command("buffer.list", "List agent buffers", "Buffers", "List main and agent conversations as Vim-style buffers.", ":ls/:buffers", "buffers", "conversation", "agents"),
		command("buffer.switch", "Switch agent buffer", "Buffers", "Switch to a main or agent conversation buffer.", ":b <buffer>", "buffer", "conversation", "agent"),
		...
		command("agent.swarm", "Start swarm run", "Agents", "Send a task to the main orchestrator so it can plan and fan out agent buffers.", ":s/:swarm", "swarm", "agent", "staged", "long running"),
		...
		command("tab.ops", "Show Ops control plane", "Ops", "Switch the right pane to live runs, queued prompts, approvals, terminal sharing, and next-turn context.", "5/:ops", "ops", "operations", "jobs", "queue"),
		...
		command("file.edit", "Edit file in Vim", "Files", "Open a project file in external Neovim for precise direct intervention.", ":edit/:e <file>", "edit", "nvim", "file"),
		...
		command("context.inspect", "Inspect next context", "Context", "Show exactly what FreeCode will attach to the next agent turn.", ":context", "context", "next prompt", "model input"),
		...
		command("palette.open", "Command palette", "Help", "Open searchable commands for buffers, Ops, approvals, terminal sharing, and Vim edits.", "Ctrl+K", "help", "commands", "cheat sheet"),
		command("help.tutorial", "Agentic Vim tutorial", "Help", "Practice the mental model: agents as buffers, Ops as control plane, Vim as precision sidecar.", ":tutorial/:tutor", "tutorial", "training", "onboarding", "game", "keybindings"),
